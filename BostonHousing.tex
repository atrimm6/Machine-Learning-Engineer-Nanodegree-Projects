...
Due to the small randomization in the code that splits our data into a training and testing set, we needed to run our program several times to find the most common optimal model and predicted price. This difficulty might be overcome by additionally running a k-fold cross validation for each maximum depth. However, this would come at the cost of significantly more computation time, and for the purposes of this project, the method employed in this paper produces a satisfactory answer.
\end{document}